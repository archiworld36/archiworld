...
import mission from "../../assets/AboutUs/Mission/Mission.png";
function Mission() {
  return (
    <div className="px-[5vw] lg:px-[2.34375vw] py-[10vw] sm:py-[7vw] lg:py-[5vw] flex flex-col gap-[5vw] lg:gap-[1vw] lg:flex-row justify-between items-center bg-black">
      <img src={mission} alt="" className="w-full lg:w-2/5 rounded-2xl" />
      <div className="lg:px-[8vw] text-white">
        <h3 style={{ fontFamily: "Playfair Display" }} className="text-[clamp(20px,5vw,120px)] sm:text-[clamp(20px,4.5vw,120px)] lg:text-[clamp(20px,3vw,120px)]">- Our Mission</h3>
        ...
        <h3 style={{ fontFamily: "Playfair Display" }} className="text-[clamp(20px,5vw,120px)] sm:text-[clamp(20px,4.5vw,120px)] lg:text-[clamp(20px,3vw,120px)] py-5">- Our Vision</h3>
