...
export default function CircularWheel() {
  ...
  const category = categories.filter((item) => item.bannerImage); // keep only items having bannerImage
    ...
    <div className="w-full pt-4 pb-[20vw] overflow-hidden flex justify-center">
      <div className="relative flex gap-[10vw] sm:gap-[7vw] lg:gap-[4vw] pt-6">
        {rotations.map((_, slotIndex) => {
          const imgIndex = (index + slotIndex) % category.length;
          const img = category[imgIndex];
          return (
            <div
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  className="overflow-hidden w-full h-full relative rounded-3xl"
                >
                  <img
                    src={img?.bannerImage}
                    alt=""
