        ...
        {isSizeOpen && (
          <>
            <div className="mt-8 relative">
              <label className="text-[clamp(10px,2.2vw,40px)] sm:text-[clamp(12px,1.9vw,30px)] lg:text-[clamp(10px,1vw,40px)] font-normal">
                Length
              </label>
              <Slider
                value={lengthRange}
              ...
              <div className="flex gap-3 items-center justify-center mt-8">
                <div className="relative">
                  ...
                  />
                  <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none text-[clamp(10px,2.2vw,40px)] sm:text-[clamp(12px,1.9vw,30px)] lg:text-[clamp(10px,1vw,40px)]">
                    mm
                  </div>
                </div>
