  ...
  return (
    <div className="px-[3vw] lg:px-[2.34375vw]">
      ...
      <div className="pt-[20px] sm:pt-[30px] lg:pt-[40px]">
        <p className="text-[#4A4A4A] text-[clamp(10px,3.5vw,40px)] sm:text-[clamp(10px,2vw,30px)] lg:text-[clamp(10px,0.9vw,40px)]">
          <span
            onClick={() => navigate("/")}
      ...
      <div className="py-[20px] sm:py-[30px] lg:py-[40px] flex flex-col lg:flex-row justify-between lg:items-center gap-[3vw]">
        <h1 className="text-[clamp(20px,7vw,120px)] sm:text-[clamp(20px,5.6vw,120px)] lg:text-[clamp(20px,4.5vw,120px)] lg:text-center capitalize leading-tight font-medium font-[Poppins]">
          Products.
        </h1>
